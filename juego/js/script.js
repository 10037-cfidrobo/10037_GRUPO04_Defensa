...
continueBtn.addEventListener("click", () => {
    ...
    total_correct.innerHTML = `${correct = 0} de ${shuffledMCQS.length} preguntas`;
});
...
next_question.addEventListener("click", () => {
    if (index !== shuffledMCQS.length - 1) {
        ...
        total_correct.innerHTML = `${correct} de ${shuffledMCQS.length} preguntas`;
        clearInterval(interval);
        ...
        points.innerHTML = `Acertaste ${correct} de ${shuffledMCQS.length}`;
